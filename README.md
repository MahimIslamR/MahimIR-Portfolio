...
# Portfolio V5  
Hello everyone!  
Let me introduce myself, I’m Mahim Islam Rachman. On this occasion, I’d like to share the portfolio website project that I’ve developed.  
...
**Website Link:**  
[https://www.mahim.my.id/](https://www.mahim.my.id/)  
...
1. **Download this project:**  
   ...
   ```bash  
   git clone https://github.com/MahimIslamR/Portofolio_V5.git  
   ```  
...
- npm dep errors
solution: open cmd in  that file and run (npm config set legacy-peer-deps true)
---
