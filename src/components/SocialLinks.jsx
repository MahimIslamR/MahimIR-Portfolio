...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/mahiMahim-IR-roman-b02483286",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Mahim Islam",
    icon: Youtube,
    url: "https://youtube.com/@mahimislamroman?si=ol4ECZTE_L9s6uDi",
    color: "#FF0000",
  ...
  },
  {
    ...
    <title>Tiktok</title>
    <g id="Icon/Social/tiktok-color" stroke="none" stroke-width="8" fill="none" fillRule="evenodd">
