...
const Komentar = () => {
    ...
    useEffect(() => {
        const commentsRef = collection(db, 'comments'); // ✅ Fixed collection name
        const q = query(commentsRef, orderBy('timestamp', 'desc')); // ✅ Fixed timestamp field
    ...
    const handleCommentSubmit = useCallback(async ({ newComment, userName, imageFile }) => {
        ...
        try {
            ...
            await addDoc(collection(db, 'comments'), { // ✅ Fixed collection name
                message: newComment, // ✅ Fixed field name
                name: userName,       // ✅ Fixed field name
                profileImage: profileImageUrl,
                timestamp: serverTimestamp(), // ✅ Fixed field name
            });
        } catch (error) {
