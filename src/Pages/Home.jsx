...
const WORDS = ["MERN Stack Developer", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/MahimIslamR" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/mahim-islam-roman-b02483286?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" },
  { icon: Instagram, link: "https://www.instagram.com/mahim.islam.r?igsh=MWdzaDhmdXg0eDZsYw==" }
];
